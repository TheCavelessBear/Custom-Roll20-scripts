...
var TokenActionBuilder = TokenActionBuilder || (() => {
    ...
    function attackBonusFormula(opts) {
        const parts = [
            abilityModReference(opts.ability || 'str')
        ];
    ...
    function damageFormula(dice, abilityKey, addMod, crit) {
        const parts = [
    ...
    function buildAttackMacro(shownName, damageName, critName, bonusFormula, economyLine) {
        return [
