...
Animates token width, height, rotation, and movement. Size animations
...
const TokenAnimator = (() => {
    ...
    function checkInstall() {
        ...
        log('Commands: ' + COMMAND + ' move | rotate | fall | shrink | grow | animate | restore | setbase | clearbase | cancel | help');
