...
Revised active files: `GroupInitiative0.9.42.js`, `SmartAoE0.30.1.js`, `DoorSounds1.0.1.js`, `ActionEconomyV2.9.0.js`, `SaveEffects1.3.2.js`, `Executioner1.0.1.js`, `AttackDamageResolver1.3.2.js`, `AoEBoom1.1.3.js`, `MapChange1.8.1.js`, `StateWipe1.1.0.js`, `BeaconAttributeTester1.0.1.js`, `TokenTriggers1.3.4.js`, `TokenAnimator1.3.1.js`, and `LootManager1.3.1.js`.
