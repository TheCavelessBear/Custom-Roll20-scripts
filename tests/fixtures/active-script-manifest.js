...
own('SmartAoE0.30.1.js', ['SmartAoE']); own('DoorSounds1.0.1.js', ['DoorSounds']); own('Fetch.js', ['Fetch']); own('TurnMarker1.js', ['TurnMarker', 'TurnOrder']); own('APILogic.js', ['APILogic']); own('ActionEconomyV2.9.0.js', ['ActionEconomyV2API']); byFile['ActionEconomyV2.9.0.js'].bindingPhases.ActionEconomyV2API = 'ready'; own('ZeroFrame.js', ['ZeroFrame']);
