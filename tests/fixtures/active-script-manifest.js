...
const files = [
  'GroupInitiative.js', 'SimpleSound.js', 'TokenMod.js', 'ScriptCards.js', 'MathOps.js', 'Plugger.js', 'libTable.js', 'Muler.js', 'SelectManager.js', 'VectorMath.js', 'MatrixMath.js', 'libInline.js', 'PathMath.js', 'checkLightLevel.js', 'libTokenMarkers.js', 'Messenger.js', 'SmartAoE.js', 'DoorSounds.js', 'Fetch.js', 'TurnMarker1.js', 'APILogic.js', 'ActionEconomyV2.8.3.js', 'ZeroFrame.js', 'SaveEffects1.3.1.js', 'MetaScriptToolbox.js', 'Executioner.js', 'HPManager1.1.1.js', 'Auras.js', 'AttackDamageResolver1.3.2.js', 'SpawnDefaultTokenV1.1.2.js', 'Dismiss.js', 'AoEBoom1.1.2.js', 'MapChange.js', 'TokenActionBuilder0.5.0.js', 'Audit.js', 'StateWipe.js', 'BeaconAttributeTester.js', 'DoorControl.js', 'TokenTriggers1.3.3.js', 'TokenAnimator1.4.js', 'HandoutAccess1.1.js', 'TargetReport1.0.js', 'LootManager1.4.js'
];
...
own('SmartAoE.js', ['SmartAoE']); own('DoorSounds.js', ['DoorSounds']); own('Fetch.js', ['Fetch']); own('TurnMarker1.js', ['TurnMarker', 'TurnOrder']); own('APILogic.js', ['APILogic']); own('ActionEconomyV2.8.3.js', ['ActionEconomyV2API']); byFile['ActionEconomyV2.8.3.js'].bindingPhases.ActionEconomyV2API = 'ready'; own('ZeroFrame.js', ['ZeroFrame']);
...
own('SpawnDefaultTokenV1.1.2.js', ['SpawnDefaultToken']); own('Dismiss.js', []); own('AoEBoom1.1.2.js', ['AoEBoom']); own('MapChange.js', ['MapChange']); own('TokenActionBuilder0.5.0.js', ['TokenActionBuilder']); own('Audit.js', ['CachedStateAudit']); own('StateWipe.js', ['PersistentStateManager']); own('BeaconAttributeTester.js', ['BeaconAttributeTester']); own('DoorControl.js', []); own('TokenTriggers1.3.3.js', ['TokenTriggers', 'TokenTriggersAPI']); own('TokenAnimator1.4.js', ['TokenAnimator']); own('HandoutAccess1.1.js', ['HandoutAccess']); own('TargetReport1.0.js', []); own('LootManager1.4.js', ['LootManager']);
...
Object.assign(handlerContracts, {
  ...
  'AttackDamageResolver1.3.2.js': { ready: 1, 'chat:message': 1, 'change:campaign:turnorder': 1 },
  ...
  'TokenAnimator1.4.js': { ready: 1, 'chat:message': 1, 'destroy:graphic': 1 }, 'HandoutAccess1.1.js': { ready: 1, 'chat:message': 1 },
  'TargetReport1.0.js': { ready: 1, 'chat:message': 1 }, 'LootManager1.4.js': { ready: 1, 'chat:message': 1 }
});
