...
const files = [
  'GroupInitiative.js', 'SimpleSound.js', 'TokenMod.js', 'ScriptCards.js', 'MathOps.js', 'Plugger.js', 'libTable.js', 'Muler.js', 'SelectManager.js', 'VectorMath.js', 'MatrixMath.js', 'libInline.js', 'PathMath.js', 'checkLightLevel.js', 'libTokenMarkers.js', 'Messenger.js', 'SmartAoE0.31.js', 'DoorSounds1.1.0.js', 'Fetch.js', 'TurnMarker1.js', 'APILogic.js', 'ActionEconomyV2.9.0.js', 'ZeroFrame.js', 'SaveEffects1.4.0.js', 'MetaScriptToolbox.js', 'Executioner.js', 'HPManager1.1.1.js', 'Auras.js', 'AttackDamageResolver1.4.0.js', 'SpawnDefaultTokenV1.1.2.js', 'Dismiss.js', 'AoEBoom1.2.0.js', 'MapChange.js', 'TokenActionBuilder0.5.0.js', 'Audit.js', 'StateWipe2.0.0.js', 'BeaconAttributeTester.js', 'DoorControl.js', 'TokenTriggers1.4.0.js', 'TokenAnimator1.5.js', 'HandoutAccess1.1.js', 'TargetReport1.0.js', 'LootManager1.5.js'
];
...
own('SmartAoE0.31.js', ['SmartAoE']); own('DoorSounds1.1.0.js', ['DoorSounds']); own('Fetch.js', ['Fetch']); own('TurnMarker1.js', ['TurnMarker', 'TurnOrder']); own('APILogic.js', ['APILogic']); own('ActionEconomyV2.9.0.js', ['ActionEconomyV2API']); byFile['ActionEconomyV2.9.0.js'].bindingPhases.ActionEconomyV2API = 'ready'; own('ZeroFrame.js', ['ZeroFrame']);
...
own('SaveEffects1.4.0.js', saveEffectsGlobals);
...
own('AttackDamageResolver1.4.0.js', adrGlobals.concat(['AttackDamageResolverAPI']));
own('SpawnDefaultTokenV1.1.2.js', ['SpawnDefaultToken']); own('Dismiss.js', []); own('AoEBoom1.2.0.js', ['AoEBoom']); own('MapChange.js', ['MapChange']); own('TokenActionBuilder0.5.0.js', ['TokenActionBuilder']); own('Audit.js', ['CachedStateAudit']); own('StateWipe2.0.0.js', ['PersistentStateManager']); own('BeaconAttributeTester.js', ['BeaconAttributeTester']); own('DoorControl.js', []); own('TokenTriggers1.4.0.js', ['TokenTriggers', 'TokenTriggersAPI']); own('TokenAnimator1.5.js', ['TokenAnimator']); own('HandoutAccess1.1.js', ['HandoutAccess']); own('TargetReport1.0.js', []); own('LootManager1.5.js', ['LootManager']);
...
const publicApis = [
  ...
  { global: 'SmartAoE', type: 'object', members: fn('ObserveTokenChange', 'maintainState') }, { global: 'DoorSounds', type: 'object', members: fn('playSound', 'maintainState') },
  ...
  { global: 'ActionEconomyV2API', type: 'object', members: fn('processDamageResult', 'hasEffect', 'getTargetStatus', 'maintainState') }, { global: 'ZeroFrame', type: 'object', members: fn('RegisterMetaOp') },
  { global: 'SaveEffectsAPI', type: 'object', members: fn('rollSave', 'maintainState') }, { global: 'AttackDamageResolverAPI', type: 'object', members: fn('maintainState') }, { global: 'SpawnDefaultToken', type: 'object', members: fn('spawnAtXY') },
  { global: 'AoEBoom', type: 'object', members: { version: 'string', maintainState: 'function' } }, { global: 'MapChange', type: 'object', members: fn('ConstructMaps', 'RegisterEventHandlers', 'CheckInstall') },
  { global: 'TokenTriggers', type: 'object', members: fn('getHpZeroConfig', 'triggerHpZero', 'restoreToken', 'getBloodiedConfig', 'getRelentlessEnduranceConfig', 'queueBloodied', 'maintainState') },
  { global: 'TokenTriggersAPI', type: 'object', members: fn('processBar1Change') },
  { global: 'TokenAnimator', type: 'object', members: fn('maintainState') }, { global: 'HandoutAccess', type: 'object', members: fn('reveal', 'hide', 'revealByReference') }, { global: 'LootManager', type: 'object', members: fn('inspect', 'maintainState') }
];
...
Object.assign(handlerContracts, {
  ...
  'libTokenMarkers.js': { ready: 1 }, 'Messenger.js': { ready: 1 }, 'SmartAoE0.31.js': { ready: 1, 'chat:message': 1, 'change:graphic': 1, 'destroy:graphic': 1 },
  'DoorSounds1.1.0.js': { ready: 1, 'chat:message': 1, 'change:door:isOpen': 1 }, 'Fetch.js': { ready: 1, 'chat:message': 3 },
  ...
  'ActionEconomyV2.9.0.js': { ready: 1, 'chat:message': 1, 'change:campaign:turnorder': 1, 'change:graphic': 1, 'change:graphic:bar1_value': 1, 'change:graphic:bar2_value': 1, 'add:graphic': 1, 'destroy:character': 1, 'destroy:graphic': 1 },
  'ZeroFrame.js': { ready: 1, 'chat:message': 2 }, 'SaveEffects1.4.0.js': { ready: 1, 'chat:message': 1 }, 'MetaScriptToolbox.js': { ready: 1 },
  'Executioner.js': { ready: 1, 'chat:message': 1 }, 'HPManager1.1.1.js': { ready: 1, 'chat:message': 1 }, 'Auras.js': { 'chat:message': 1 },
  'AttackDamageResolver1.4.0.js': { ready: 1, 'chat:message': 1, 'change:campaign:turnorder': 1 },
  'SpawnDefaultTokenV1.1.2.js': { ready: 1, 'chat:message': 1 }, 'Dismiss.js': { 'chat:message': 1 }, 'AoEBoom1.2.0.js': { ready: 1, 'chat:message': 1, 'change:graphic': 1 },
  'MapChange.js': { ready: 1, 'chat:message': 1 }, 'TokenActionBuilder0.5.0.js': { ready: 1, 'chat:message': 1 }, 'Audit.js': { ready: 1, 'chat:message': 1 },
  'StateWipe2.0.0.js': { ready: 1, 'chat:message': 1 }, 'BeaconAttributeTester.js': { ready: 1, 'chat:message': 1 }, 'DoorControl.js': { ready: 1, 'chat:message': 1 },
  'TokenTriggers1.4.0.js': { ready: 1, 'chat:message': 1, 'change:campaign:turnorder': 1, 'change:graphic:bar1_value': 1, 'destroy:character': 1, 'destroy:graphic': 1 },
  'TokenAnimator1.5.js': { ready: 1, 'chat:message': 1, 'destroy:graphic': 1 }, 'HandoutAccess1.1.js': { ready: 1, 'chat:message': 1 },
  'TargetReport1.0.js': { ready: 1, 'chat:message': 1 }, 'LootManager1.5.js': { ready: 1, 'chat:message': 1 }
});
